...
class CMainFrameBase : public wxFrame
{
	...
	public:
		...
		CMainFrameBase( wxWindow* parent, wxWindowID id = wxID_MAINFRAME, const wxString& title = _("dorabmon"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 820,560 ), long style = wxDEFAULT_FRAME_STYLE|wxRESIZE_BORDER|wxTAB_TRAVERSAL );
		~CMainFrameBase();
...
class CAboutDialogBase : public wxDialog
{
	...
	public:
		...
		CAboutDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("About dorabmon"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 580,460 ), long style = wxDEFAULT_DIALOG_STYLE );
		~CAboutDialogBase();
...
class CYourAddressDialogBase : public wxDialog
{
	...
	public:
		CYourAddressDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Your dorabmon Addresses"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 680,450 ), long style = wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER );
